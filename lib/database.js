...
connection.createAsyncStatement("CREATE TABLE IF NOT EXISTS delivery (target TEXT, in_reply_to TEXT, title TEXT, content TEXT, last_try INTEGER, tries INTEGER)").executeAsync();
...
function add_deliver(targets, item) {
