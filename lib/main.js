      ...
      "onMessage": function(list) {
        for (var i=0; i<list.length; i++) {
          ...
          if (item.type=="atom") {
            ...
            // make list of identities from all sites
            var identities = {};
            ...
            panel.port.emit("list-sites", sites);
            panel.port.emit("list-identities", identities);
...
// look for intro metatag
// panel: show identities, allow to select/create, set body
// on submit: make intro request
// on response: add to config
